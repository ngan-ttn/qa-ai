"""Derive current testcase dispositions and a Markdown execution summary."""
...
def main()->int:
    ap=argparse.ArgumentParser(description=__doc__); ap.add_argument("run_path"); args=ap.parse_args(); d=Path(args.run_path).resolve()
