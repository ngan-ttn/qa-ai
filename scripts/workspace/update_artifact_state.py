...
def main() -> int:
    ...
    # Approval must be an explicit operator action. This script provides the controlled
    # transition mechanism but does not infer human approval from generation/self-review.
    timestamp = now_iso()
