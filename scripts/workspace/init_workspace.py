...
def main() -> int:
    ...
    validate_id(args.project, "project ID")
    validate_id(args.feature, "feature ID")
    ...
    if metadata_path.exists():
        print(f"ERROR workspace already initialized: {metadata_path.relative_to(ROOT)}")
        return 1
    ...
    metadata = {
        ...
        "feature_name": args.name or args.feature,
        "status": "Active",
